...
class AstarRoute:
    ...
    def __init__(self, graph, shortest_dist, path_limit, elevation_strategy, starting_node, ending_node, shortest_path_elevation_gain):
    ...
    def get_shortest_route(self):
        ...
        while self.scaling_factor < 10000:
            ...
            elevation_route = nx.astar_path(graph, source=self.starting_node, target=self.ending_node,
                                                heuristic=self.dist,
                                                weight=lambda u, v, d:
